...
export default function CampaignDetailPanel({ 
  ...
  const getPlatformName = (_platform: string): string => {
    ...
    return names[_platform as keyof typeof names] || 'Other'
  }
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {campaign.target_platforms?.map((_platform: string) => (
                                <span key={_platform} className="px-3 py-1 bg-purple-100 text-purple-800 text-sm font-medium rounded-full">
                                  {_platform}
                                </span>
                              ))}
                            </div>
