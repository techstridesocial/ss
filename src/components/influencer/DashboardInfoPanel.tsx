        ...
        >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain">
              ...
              <div className="border-b border-gray-100">
                <div className="py-6 px-6">
                  <h3 className="text-lg font-semibold text-gray-900 tracking-tight leading-tight mb-4">
                    Contact Information
                  </h3>
                  <div className="space-y-4">
                    ...
                    {/* WhatsApp Group Link */}
                    <div className="pt-2 border-t border-gray-100 min-h-[160px]">
                      {whatsappUrl && !isAddingWhatsApp ? (
                        <div className="flex items-center justify-between">
                          <a
                            href={whatsappUrl}
                            target="_blank"
