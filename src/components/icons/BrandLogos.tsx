...
// Core influencer platform brand logos (Instagram, YouTube, TikTok)
...
export const TikTokLogo = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
  </svg>
)

export const LinktreeLogo = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
// Brand color classes for supported platforms
export const brandColors = {
  ...
  linktree: 'text-green-500 hover:text-green-600',
  twitter: 'text-blue-400 hover:text-blue-500',
  x: 'text-gray-900 hover:text-black',
...
// Helper function to get the right logo component
export const getBrandLogo = (platform: string, className?: string) => {
  ...
  switch (platformType) {
    ...
    case 'linktree':
      return <LinktreeLogo className={className} />
    case 'twitter':
    case 'x':
    ...
    case 'link':
    case 'url':
      return <WebsiteLogo className={className} />
    default:
      return <WebsiteLogo className={className} /> // Generic website icon for unknown types
  }
}

// Helper function to get brand color
export const getBrandColor = (_platform: string): string => {
  const platformType = _platform.toLowerCase() as keyof typeof brandColors
