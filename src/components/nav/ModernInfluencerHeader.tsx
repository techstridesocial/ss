...
export default function ModernInfluencerHeader() {
  ...
  const getPageHeader = () => {
    ...
    if (pathname === '/influencer/campaigns' || pathname.startsWith('/influencer/campaigns/')) {
      ...
      return {
        ...
        subtitle: 'Track your social media performance and engagement metrics'
      }
    } else if (pathname === '/influencer/payments' || pathname.startsWith('/influencer/payments/')) {
      return {
        title: 'Payment Center',
        subtitle: 'Manage your payment methods and track your earnings'
      }
    } else if (pathname === '/influencer/profile' || pathname.startsWith('/influencer/profile/')) {
      return {
        title: 'Your Profile',
        subtitle: 'Manage your personal information and social media connections'
      }
    } else {
          ...
          <div className="relative z-10">
            ...
            <div className="w-full h-[72px] px-4 lg:px-8 flex items-center justify-between">
              ...
              <div className="flex items-center">
                <Link href="/influencer/campaigns" className="flex items-center">
                  <img 
