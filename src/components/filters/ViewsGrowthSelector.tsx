...
interface ViewsGrowthSelectorProps {
...
const ViewsGrowthSelector: React.FC<ViewsGrowthSelectorProps> = ({
  growthPercentage,
  growthPeriod,
  ...
  return (
    <div>
      <label className="block text-sm font-medium text-gray-700 mb-2">Views Growth</label>
...
export default ViewsGrowthSelector 