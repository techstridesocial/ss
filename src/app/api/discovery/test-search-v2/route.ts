...
export async function POST(request: Request) {
  try {
    ...
    console.log('🧪 Test Search v2 API request:', {
    ...
    if (!result.success) {
      console.error('❌ Test Search v2 failed:', result.error)
    ...
    console.log('✅ Test Search v2 success:', {
    ...
    console.error('❌ Error in test search v2 API route:', error)
    return NextResponse.json(
