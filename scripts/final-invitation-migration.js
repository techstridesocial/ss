...
/**
 * Final invitation migration that works with existing database
 */
...
async function applyMigration() {
  ...
  try {
    ...
    // Step 1: Create user_invitations table using existing invitation_status enum
    ...
    // Step 4: Create clerk_webhook_events table
    ...
    console.log('   - Using existing invitation_status enum')
    console.log('   - Update triggers')
    console.log('')
    console.log('📝 Note: Using existing invitation_status enum values:')
    console.log('   - INVITED (instead of PENDING)')
    console.log('   - ACCEPTED')
    console.log('   - DECLINED (instead of REVOKED)')
    console.log('   - EXPIRED')
    console.log('')
